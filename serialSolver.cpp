...
int main(int argc, char *argv[]) {
    if (!argv[1]) {
        cout << "Please run the code as ./main <board_size>" << endl;
        return 0;
    }
    ...
    cout<<"Total serial time taken to solve a "<<SIZE<<"x"<<SIZE<<" Sudoku Board : "<<duration.count()<<endl;
	logFile<<"Total serial time taken to solve a "<<SIZE<<"x"<<SIZE<<" Sudoku Board : "<<duration.count()<<endl;
	logFile << "============================================================================================"<<endl;
	logFile.close();
}
